...
func (h *Handler) RegisterRoutes(rg *gin.RouterGroup) {
	...
	rg.GET("/:id", h.GetListener); rg.PUT("/:id", h.UpdateListener)
	rg.DELETE("/:id", h.DeleteListener); rg.POST("/:id/reload", h.ReloadListener)
	rg.POST("/:id/clone", h.CloneListener); rg.GET("/:id/versions", h.ListVersions)
	rg.GET("/:id/versions/:version/diff", h.DiffVersion); rg.POST("/:id/versions/:version/rollback", h.RollbackVersion)
