...
// Settings is the panel-editable Telegram configuration.
...
// LoadSettings reads Telegram settings from PanelSetting.
...
// SaveSettings persists Telegram settings.
...
// NewClientFromDB builds a Client when enabled and configured.
