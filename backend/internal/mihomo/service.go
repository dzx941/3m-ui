...
func (s *Service) SaveConfig(content string) error {
	if s == nil || s.cm == nil || s.pm == nil { return fmt.Errorf("mihomo service not initialized") }
...
func (s *Service) ApplyConfig(content string) error {
	if s == nil || s.pm == nil || s.cm == nil { return fmt.Errorf("mihomo service not initialized") }
	old, readErr := s.cm.ReadConfig()
